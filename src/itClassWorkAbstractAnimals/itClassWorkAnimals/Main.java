package itClassWorkAbstractAnimals.itClassWorkAnimals;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(itClassWorkAbstractAnimals.Cow.myToString());

        itClassWorkAbstractAnimals.Main.main(args);
